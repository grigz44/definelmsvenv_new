...
class UserLoginForm(forms.Form):
    username = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control','id':'name','placeholder': 'Username','onclick':'resetBtn()'}))
    password = forms.CharField(widget=forms.PasswordInput(attrs={'class': 'form-control','id':'pass','placeholder': 'Password','onclick':'resetBtn()','minlength':'8'}))
    class Meta:
        model = login
        fields = ('username','password')
